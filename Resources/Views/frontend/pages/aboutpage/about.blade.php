...
{{-- <section class="portfolio_filter  mb-20 bg-white dark:bg-gray-900">
    <x-portfolio_filter.primary></x-portfolio_filter.primary>
</section> --}}
...
<section class="bg-gray-100 lg:pt-16 text-gray-800">
	<div class="container flex flex-col justify-center p-12 mx-auto sm:py-24 lg:py-12 lg:flex-row lg:justify-around">
		...
		<div class="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
			<img src="{{ public_path('assets/images/me.jpg') }}" alt="" class="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 rounded-3xl">
		</div>
	</div>
</section>
