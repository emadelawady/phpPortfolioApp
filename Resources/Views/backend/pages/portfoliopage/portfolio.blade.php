...
<section class="mt-10 mb-20">
    ...
    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
        ...
        <tr>
            ...
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $portfolio->description }}</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $portfolio->link }}</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $portfolio->built_with }}</td>
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="{{ route('admin.portfolio.show', ['id' => $portfolio->id]) }}"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="{{ route('admin.portfolio.edit', ['id' => $portfolio->id]) }}"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <form
                    action="{{ route('admin.portfolio.delete', ['id' => $portfolio->id]) }}"
                    method="POST"
