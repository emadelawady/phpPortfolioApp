<?php if(has_session('message_with_data')): ?>
    ...
    <div class="bg-white border-gray-300 border p-3 flex items-start shadow-lg rounded-md space-x-2">
      ...
      <div class="flex-1 space-y-1">
        <p class="text-base leading-6 font-medium text-gray-700">
            ...
            <?php echo e(get_session('message_with_data')); ?>

            <?php echo e(unflash_message('message_with_data')); ?>


        </p>

        <?php if(has_session('last_added_is')): ?>
            <p class="text-sm leading-5 text-gray-600">
                view <a class="text-primary font-bold" href="<?php echo e(route('admin.portfolio.show', ['id' => get_session('last_added_is')])); ?>">here</a>
                <?php echo e(unflash_message('last_added_is')); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\Resources\Views/components/globals/sessions/success-id.blade.php ENDPATH**/ ?>