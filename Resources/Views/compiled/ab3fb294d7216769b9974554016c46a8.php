  ...
  <!-- Dropdown menu -->
    ...
    >
        <a href="#" class="flex items-center p-3 -mt-2 text-sm text-gray-600 transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <div class="mx-1">
                <h1 class="text-sm font-semibold text-gray-700 dark:text-gray-200"><?php echo e($user->name); ?></h1>
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\Resources\Views/components/globals/admins/dropdown-user.blade.php ENDPATH**/ ?>