<section class="bg-white dark:bg-gray-900">
    ...
    <div class="max-w-6xl px-6 py-10 mx-auto">
            <h1 class="py-10 text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">
            What clients saying
        </h1>
        <p class="mt--2 text-xl font-medium text-blue-500 ">Testimonials</p>
...
</section><?php /**PATH C:\laragon\www\phpPortfolioApp\Resources\Views/components/testimonials/primary.blade.php ENDPATH**/ ?>