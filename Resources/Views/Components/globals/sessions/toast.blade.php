@if(has_session('toast'))

<div x-init="$nextTick(() => {$dispatch('notice', {type: 'success', text: '🔥 {{ get_session('toast') }}{{unflash_message('toast') }}'})})" class="flex items-center justify-center">
