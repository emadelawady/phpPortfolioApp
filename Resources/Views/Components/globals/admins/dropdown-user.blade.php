...
@if ($_SESSION['user'] ?? false)
    ...
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200">
        <a href="{{ route('login') }}" class="px-2.5 py-2 md:mx-2 {{ is_current_route('login') ? 'active' : '' }}">Login</a>
    </li>
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200">
        <a href="{{ route('register') }}" class="px-2.5 py-2 md:mx-2 {{ is_current_route('register') ? 'active' : '' }}">Register</a>
    </li>
    @endif --}}
{{-- 
</div>
...
<div class="relative hidden lg:flex mt-4 md:mt-0">
   <x-dropdowns.AuthOrGuest></x-dropdowns.AuthOrGuest>
</div> --}}
