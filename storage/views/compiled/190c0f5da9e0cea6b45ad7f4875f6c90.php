...
<section class="dark:bg-gray-800 dark:text-gray-50">
	...
	<form novalidate="" action="<?php echo e(route('admin.blog.update',['id' => $blog->id])); ?>" method="POST" class="container flex flex-col mx-auto space-y-6">
  <input type="hidden" name="_method" value="PATCH">
		<fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
			<div class="space-y-2 col-span-full lg:col-span-1">
				<p class="font-bold text-lg text-primary">Blog</p>
			...
			<div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div class="col-span-full">
					...
					><?php echo e($blog->content); ?></textarea>
				</div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/backend/blog/components/edit.blade.php ENDPATH**/ ?>