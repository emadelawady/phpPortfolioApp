...
<section class="dark:bg-gray-800 dark:text-gray-50">
    <div class="mx-auto max-w-screen-2xl mt-6 px-4 md:px-8">
        ...
        <div class="flex flex-wrap mb-3">
            <a class="bg-primary text-white py-1 px-3 my-6 rounded-md" href="<?php echo e(route('admin.services.index')); ?>">
	...
	<form novalidate="" action="<?php echo e(route('admin.service.update',['id' => $service->id])); ?>" method="POST" class="container flex flex-col mx-auto space-y-6">
			...
			<div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div class="col-span-full sm:col-span-3">
					...
					<input
						...
						class="w-full rounded-md dark:border-gray-700 dark:text-gray-900"
						value="<?php echo e($service->skills); ?>"
					>
				</div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/backend/pages/servicespage/components/edit.blade.php ENDPATH**/ ?>