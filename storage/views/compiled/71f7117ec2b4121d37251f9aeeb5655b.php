    ...
    <div class="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div class="px-6 py-4">
            ...
            <form action="<?php echo e(route('register.post')); ?>" method="POST">
                <div class="w-full relative mt-4">
                    <input class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="text" name="name" placeholder="User Name" aria-label="User Name" value="<?php echo e(old('name')); ?>" />
                ...
                <div class="w-full mb-6">
                  <?php echo e(isset($errors['name']) ? check_validation($errors['name']) : false); ?>
        ...
        <div class="w-full flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
            <?php if(isset($errors['AlreadyExists'])): ?>
              <p class="mt-3 text-xs text-red-600"><?php echo e($errors['AlreadyExists']); ?></p>
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/auth/register.blade.php ENDPATH**/ ?>