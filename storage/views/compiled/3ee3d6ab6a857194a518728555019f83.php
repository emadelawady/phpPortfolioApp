...
<section class="bg-white dark:bg-gray-900">
    <div class="hold-swiper container px-10 py-10 mx-auto">
        <h1 class="head_underline text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Portfolios
        </h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide mt-8 xl:mt-12">
      ...
      <div class="swiper-slide mt-8 xl:mt-12">Slide 8</div>
      <div class="swiper-slide mt-8 xl:mt-12">Slide 9</div>
    </div>
...
</section><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/components/slider/primary.blade.php ENDPATH**/ ?>