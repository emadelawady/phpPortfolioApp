...
<section class="dark:bg-gray-800 dark:text-gray-50">
	...
	<form novalidate="" action="<?php echo e(route('admin.portfolio.update',['id' => $portfolio->id])); ?>" method="POST" class="container flex flex-col mx-auto space-y-6">
			...
			<div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div class="col-span-full sm:col-span-3">
					...
					<input
						...
						class="w-full rounded-md dark:border-gray-700 dark:text-gray-900"
						value="<?php echo e($portfolio->built_with); ?>"
					>
				</div>
				<div class="col-span-full">
					...
					<input
						...
						placeholder="Heading plus"
						class="w-full rounded-md dark:border-gray-700 dark:text-gray-900"
						value="<?php echo e($portfolio->link); ?>"
					>
				</div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/backend/pages/portfoliopage/components/edit.blade.php ENDPATH**/ ?>