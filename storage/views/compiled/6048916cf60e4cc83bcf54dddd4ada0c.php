...
<section class="dark:bg-gray-800 dark:text-gray-50">
	...
	<form novalidate="" action="<?php echo e(route('admin.testimonial.store')); ?>" method="POST" class="container flex flex-col mx-auto space-y-6" enctype="multipart/form-data">
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/backend/pages/testimonialspage/components/create.blade.php ENDPATH**/ ?>