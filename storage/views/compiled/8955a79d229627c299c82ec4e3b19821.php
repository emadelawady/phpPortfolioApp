  ...
  <div class="flex flex-wrap items-center sm:-mx-3">
    ...
    <div class="w-full md:w-1/2">
      <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl" data-rounded="rounded-xl" data-rounded-max="rounded-full">
          <img class="w-24 h-24" src="<?php echo e(public_path('assets/images/person.jpg')); ?>">
        </div>
    </div>
  </div>
</div>

<?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/components/hero/primary.blade.php ENDPATH**/ ?>