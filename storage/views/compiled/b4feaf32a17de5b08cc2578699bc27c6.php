<section class="bg-white dark:bg-gray-900">
    <div class="hold-swiper container px-10 py-10 mx-auto">
        ...
        <p class="mt-4 text-left text-gray-500 dark:text-gray-300">
            see full portfolio  
            <a class="text-blue-500" href="<?php echo e(route('portfolio')); ?>">page</a>
        </p>
          <!-- Swiper -->
  <div class="swiper homepage_portfolio_slider">
    <div class="swiper-wrapper">
    <?php $__currentLoopData = $portfolios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>      
      <a href="<?php echo e(route('portfolio.show',['id' => $portfolio->id])); ?>" class="swiper-slide mt-8 xl:mt-12">    
        <div class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
                style="background-image:url(<?php echo e(public_path('/assets/images/portfolio/') . $portfolio->featured_image); ?>)">
            <div
                ...
                <h2 class="mt-4 text-xl font-semibold text-white capitalize"><?php echo e($portfolio->name); ?></h2>
...
</section><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/frontend/pages/homepage/components/portfolio.blade.php ENDPATH**/ ?>