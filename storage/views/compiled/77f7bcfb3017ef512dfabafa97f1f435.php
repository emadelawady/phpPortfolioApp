  ...
  <dl class="-my-3 divide-y divide-gray-100 text-sm">
    ...
    >
      ...
      <dd class="text-gray-700 sm:col-span-2">
        <img class="w-40 rounded-xl" src="<?php echo e(public_path("assets/images/portfolio/$service->featured_image")); ?>" alt="">
      </dd>
    </div>
    <div
      class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4"
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/backend/pages/servicespage/components/show.blade.php ENDPATH**/ ?>