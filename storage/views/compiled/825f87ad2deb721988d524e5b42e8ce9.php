...
<section class="mt-10 mb-20">
    ...
    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
        ...
        <tr>
            ...
            <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo e($blog->content); ?></td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo e($blog->rate); ?></td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo e($blog->tags); ?></td>
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="<?php echo e(route('admin.blog.show', ['id' => $blog->id])); ?>"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="<?php echo e(route('admin.blog.edit', ['id' => $blog->id])); ?>"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <form
                    action="<?php echo e(route('admin.blog.delete', ['id' => $blog->id])); ?>"
                    method="POST"
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/admins/blog/index.blade.php ENDPATH**/ ?>