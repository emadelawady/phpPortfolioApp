...
<section class="mt-10 mb-20">
    ...
    <!-- Border -->
        ...
        href="<?php echo e(route('admin.testimonial.create')); ?>"
        >
        Create
        </a>
    </div>
    ...
    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
        ...
        <tr>
            ...
            <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo e($testimonial->content); ?></td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo e($testimonial->rate); ?></td>
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="<?php echo e(route('admin.testimonial.show', ['id' => $testimonial->id])); ?>"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="<?php echo e(route('admin.testimonial.edit', ['id' => $testimonial->id])); ?>"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <form
                    action="<?php echo e(route('admin.testimonial.delete', ['id' => $testimonial->id])); ?>"
                    method="POST"
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/backend/pages/testimonialspage/testimonials.blade.php ENDPATH**/ ?>