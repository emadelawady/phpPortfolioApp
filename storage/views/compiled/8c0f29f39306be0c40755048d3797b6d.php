            ...
            <div class="container px-6 py-3 mx-auto md:flex">
                ...
                <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between">
                    <div class="flex flex-col px-2 -mx-4 md:flex-row md:mx-10">
                        ...
                        <li class="nav-item list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200 <?php echo e(is_current_route('about', if_false:'btn-text-links')); ?>">
                            <a href="<?php echo e(in_route('about') ? 'javascript:void(0)' : route('about')); ?>" class="px-2.5 py-2 md:mx-2 font-semibold <?php echo e(is_current_route('about', if_true:'active font-semibold cursor-default', if_false:'hover:text-primary')); ?>">About</a>
                        </li>
...
<?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/frontend/components/navbars/navbar-links.blade.php ENDPATH**/ ?>