...
<section class="mt-10 mb-20">
    <div class="bg-white py-3 sm:py-4 lg:py-6">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <h2 class="mb-4 text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Users</h2>
    ...
    <!-- Border -->
        ...
        href="<?php echo e(route('admin.user.create')); ?>"
        >
        Create
        </a>
    </div>
    ...
    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
        ...
        <tr>
            ...
            <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo e($user->email); ?></td>
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="<?php echo e(route('admin.user.show', ['id' => $user->id])); ?>"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="<?php echo e(route('admin.user.edit', ['id' => $user->id])); ?>"
            ...
            <td class="whitespace-nowrap px-4 py-2">
                <form
                    action="<?php echo e(route('admin.user.delete', ['id' => $user->id])); ?>"
                    method="POST"
...
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\resources\views/backend/pages/userspage/users.blade.php ENDPATH**/ ?>