...
<section class="mt-10 mb-20">
    ...
    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
        ...
        <tr>
            ...
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $service->description }}</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $service->link }}</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $service->skills }}</td>
            <td class="whitespace-nowrap px-4 py-2">
                <a
                    href="{{ route('admin.service.show', ['id' => $service->id]) }}"
