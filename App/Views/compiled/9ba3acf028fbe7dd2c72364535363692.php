...
<?php if($_SESSION['user'] ?? false): ?>
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200 px-2">
        <span class="active"><?php echo e($_SESSION['user']['name']); ?></span>
    </li>
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200 px-2">
    ...
    <div x-data="{
        ...
        <button @click="dropdownOpen=true" class="inline-flex items-center justify-center h-12 py-2 pl-3 pr-12 text-sm font-medium transition-colors bg-white text-neutral-700 hover:bg-neutral-100 active:bg-white focus:bg-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
            ...
            <span class="flex flex-col items-start flex-shrink-0 h-full ml-2 leading-none translate-y-px">
                <span><?php echo e(get_session('user')['name']); ?></span>
                <span class="text-xs font-light text-neutral-400"><?php echo e(get_session('user')['email']); ?></span>
            </span>
...
</div><?php /**PATH C:\laragon\www\phpPortfolioApp\App\Views/components/dropdown-user-data.blade.php ENDPATH**/ ?>