...
<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
  <div class="mx-auto max-w-lg">
    ...
    <form
      action="<?php echo e(route('register.post')); ?>"
      method="POST"
      class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8"
    >
      <p class="text-center text-lg font-medium">Register A New Account</p>
      ...
      <div>
        ...
        <div class="relative">
          ...
          <span class="absolute inset-y-0 end-0 grid place-content-center px-4">
            ...
            <p class="bg-gray-200 text-red-600 p-2 px-4 text-sm"><?php echo e($errors['name']); ?></p>
      ...
      <div>
        ...
        <div class="relative">
          ...
          <span class="absolute inset-y-0 end-0 grid place-content-center px-4">
            ...
            <p class="bg-gray-200 text-red-600 p-2 px-4 text-sm"><?php echo e($errors['email']); ?></p>
        ...
        <div class="relative">
          ...
          <span class="absolute inset-y-0 end-0 grid place-content-center px-4">
            ...
            <div class="block py-4">
                ...
                <p class="bg-gray-200 text-red-600 p-2 px-4 text-md"><?php echo e($errors['password']); ?></p>
    ...
    <div class="block py-4">
        <?php if(isset($errors['already_exists'])): ?>
            ...
            <p class="bg-gray-200 text-red-600 p-2 px-4 text-md"><?php echo e($errors['already_exists']); ?>
...
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?><?php /**PATH C:\laragon\www\phpPortfolioApp\App\Views/auth/register.blade.php ENDPATH**/ ?>