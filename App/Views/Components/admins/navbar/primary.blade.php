{{-- <nav class="fixed top-0 z-50 w-full bg-primary-light border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="{{ route('homepage') }}" class="flex ml-2 md:mr-24">
          <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" />
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">PhpWebApp</span>
        </a>
      </div>
          ...
          <div class="flex items-center ml-3">
            ...
            @if ($_SESSION['user'] ?? false)
              ...
              <ul class="py-1" role="none">
                ...
                <li>
                  <form action="{{ \Core\Helper::route('logout') }}" method="POST" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
        ...
        <div class="lg:flex lg:items-center lg:justify-between">
            ...
            <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
                {{-- <div class="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                  ...
                  <x-locals.admins.theme-switch></x-locals.admins.theme-switch>
                  ...
                  <div class="flex items-center mt-4 lg:mt-0">
                    ...
                    <x-globals.admins.dropdown-user/>
