<div class="relative flex lg:hidden mt-4 md:mt-0">

@if ($_SESSION['user'] ?? false)
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200 px-2">
        <span class="active">{{ $_SESSION['user']['name'] }}</span>
    </li>
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200 px-2">
    ...
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200">
        {{-- <a href="{{ route('login') }}" class="px-2.5 py-2 md:mx-2 {{ \Core\Helper::is_current_route('login') ? 'active' : '' }}">Login</a> --}}
    </li>
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200">
        {{-- <a href="{{ route('register') }}" class="px-2.5 py-2 md:mx-2 {{ \Core\Helper::is_current_route('register') ? 'active' : '' }}">Register</a> --}}
    </li>
    @endif

</div>

<div class="relative hidden lg:flex mt-4 md:mt-0">
...
@if ($_SESSION['user'] ?? false)
    ...
    <div x-data="{
        ...
        <button @click="dropdownOpen=true" class="inline-flex items-center justify-center h-12 py-2 pl-3 pr-12 text-sm font-medium transition-colors bg-white text-neutral-700 hover:bg-neutral-100 active:bg-white focus:bg-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
            ...
            <span class="flex flex-col items-start flex-shrink-0 h-full ml-2 leading-none translate-y-px">
                <span>{{ get_session('user')['name'] }}</span>
                <span class="text-xs font-light text-neutral-400">{{ get_session('user')['email']}}</span>
            </span>
        ...
        <div x-show="dropdownOpen" 
            ...
            <div class="p-1 mt-1 bg-white border rounded-md shadow-md border-neutral-200/70 text-neutral-700">
                ...
                {{-- <a href="{{ route('admin.profile') }}" class="relative flex cursor-pointer select-none hover:bg-neutral-100 items-center rounded px-2 py-1.5 text-sm outline-none transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50"> --}}
                ...
                <div class="h-px my-1 -mx-1 bg-neutral-200"></div>
                <a href="javascript:void(0);" class="relative flex cursor-default select-none hover:bg-neutral-100 items-center rounded px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50">
    ...
    @else
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200">
        <a href="/login" class="px-2.5 py-2 md:mx-2">Login</a>
    </li>
    <li class="list-none text-gray-700 transition-colors duration-300 transform dark:text-gray-200">
        <a href="/register" class="px-2.5 py-2 md:mx-2 ">Register</a>
    </li>
    @endif
